...
<!-- visual:start -->
![Cloudflareのコスト発生ポイント](assets/diagrams/12_cost_model.svg)

> **図の要点:** 固定プランだけでなく、Workers・R2・D1・Queuesなどの従量費をリクエスト処理単位で把握する。
<!-- visual:end -->
...
<!-- visual:start -->
![TCOでの比較方法](assets/diagrams/12_cost_estimation.svg)

> **図の要点:** Cloudflare請求額だけでなく、Origin転送量・運用工数・障害リスク・既存クラウド費用まで含めて比較する。
<!-- visual:end -->
